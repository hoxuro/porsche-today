...
function initMenu() {
  ...
  var t = jQuery,
    e = t("body");
  t("#main-menu")
    .find(".parent > a .open-sub, .megamenu .title .open-sub")
    .remove(),
    t("#main-menu")
    ...
    t("#main-menu").on("click", ".open-sub", function (e) {
      ...
      if (t(i).hasClass("active"))
        t(i).children().last().slideUp(150), t(i).removeClass("active");
      else {
        var n = t(this)
          .closest("li, .box")
          .parent("ul, .sub-list")
          .children("li, .box");
        t(n).is(".active") &&
          t(n).removeClass("active").children("ul").slideUp(150),
...
function initAffixCheck() {
  ...
  t.affix({ offset: { top: 1 } }),
    windowT.width() < 1025 &&
      !$("#nav").hasClass("affix-on-mobile") &&
      (windowT.off(".affix"),
      t.removeData("bs.affix").removeClass("affix affix-top affix-bottom")),
    $("#nav").hasClass("affix-on-mobile") &&
      $(".nav.navbar-nav").css(
        "max-height",
...
function initFlickrFeeds() {
  $("#flickr-feeds").jflickrfeed({
    ...
    itemTemplate:
      '<li><a class="lightbox" rel="colorbox" href="{{image}}" title="{{title}}"><img src="{{image_s}}" alt="{{title}}" /></a></li>',
  });
}
...
function initMap() {
  !(function (t) {
    if (gmMapDiv.length) {
      ...
      gmMapDiv.gmap3({
        action: "init",
        marker: { latLng: [e, i], options: { icon: "images/loc-marker.png" } },
        map: {
          options: {
            zoom: 18,
            zoomControl: !0,
...
function initPageSliders() {
  !(function (t) {
    ...
    t(".owl-carousel").lenth) &&
      (e = t(".owl-carousel").data("owlCarousel")).reinit();
  })(jQuery);
}
function register(t) {
  $.ajax({
      ...
      (this.WOW = (function () {
        ...
        return (
          ...
          (a.prototype.vendorCSS = function (t, e) {
            var i, a, o, s, r, l;
            for (
              s = (r = n(t)).getPropertyCSSValue(e),
                i = 0,
                a = (o = this.vendors).length;
              a > i;
              i++
            )
