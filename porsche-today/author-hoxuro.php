    ...
    <div id="wrap" class="boxed ">
        <div class="grey-bg"> <!-- Grey BG  -->
            ...
            <div class="header-transporent-bg-black">
                ...
                <!-- STATIC MEDIA IMAGE -->
                <div id="index-link" class="sm-img-bg-fullscr parallax-section" style="background-image: url(<?php echo bloginfo('template_directory') ?>/assets/images/static-media/personal.jpg)" data-stellar-background-ratio="0.5">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-6 right-50 mt-768">
                            <div class="row">
                                <div class="imagen" style="background-image: url(<?php echo get_user_meta($curauth->ID, 'user_pic', true); ?>); background-size: cover;"></div>
                            </div>
                        </div>
            ...
            <div class="img-circuit" style="background-image: url(<?php echo bloginfo('template_directory') ?>/assets/images/search-bg.jpg)">
                <div class="video-ads-text-cont clearfix video-container">
