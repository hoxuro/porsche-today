...
<body>
    ...
    <div id="wrap" class="boxed ">
        <div class="grey-bg"> <!-- Grey BG  -->
            ...
            <!-- PAGE TITLE SMALL -->
            <div class="reviews-bg page-title-cont page-title-large grey-dark-bg page-title-img  pt-300 blog-bg" style="background-image: url(<?php echo bloginfo('template_directory') ?>/assets/images/reviews-bg.jpg)">
                <div class="relative container align-left">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="my-page-title my-text-shadow">REVIEWS</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container p-140-cont">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 blog-main-posts">
                        ...
                        <h2 class="section-title section-title-blog">LATEST <span class="bold">REVIEWS</span></h2>
                                ...
                                if (has_post_thumbnail()) {
                                    ...
                                    <div class="col-md-6 wow fadeIn pb-70 post-item">
                                        ...
                                        <div class="post-prev-text">
                                            <?php do_shortcode('[hah_show_main_fields id="' . $post->ID . '"]'); ?>
